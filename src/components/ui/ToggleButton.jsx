...
const ToggleButton = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "group peer h-12 w-24 rounded-full bg-rose-500 shadow-md outline-none ring-0 duration-300 after:duration-300 peer-checked:bg-primary peer-focus:outline-none",
