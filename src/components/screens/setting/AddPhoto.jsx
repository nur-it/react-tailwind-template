      ...
      <div className="p-7">
        <form action="#">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              <span className="mb-1.5 font-medium text-black">
                Edit your photo
              </span>
          ...
          <div
            id="FileUpload"
            className="relative mb-5 block w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-gray-100 px-4 py-4 dark:bg-meta-4 md:py-7"
          >
            <input
              type="file"
              accept="image/*"
          ...
          <div className="flex justify-end gap-4">
            <button
              className="flex justify-center rounded border border-stroke px-6 py-2 font-medium text-black hover:shadow-sm"
              type="submit"
            >
              Cancel
            </button>
